...
"""
Rebuild freshfish_menu.html using the experimental PNG photos from menu_screen.
Menu items without a matching photo keep the fish icon placeholder.
"""
import base64, os

BASE_DIR  = os.path.dirname(os.path.abspath(__file__))
PHOTO_DIR = os.path.join(BASE_DIR, "menu_screen")
OUT       = os.path.join(BASE_DIR, "freshfish_menu.html")
...
def combo_card(card_id, photo_key, name_ru, name_kz, price, col1_title, col1, col2_title, col2):
    img = img_tag(P[photo_key], name_ru)
    return f"""
  <div class="card card-combo" id="{card_id}">
    ...
    <div class="combo-body">
      <div class="combo-cols">
        <div class="combo-col"><strong>{col1_title}</strong>{col1}</div>
        <div class="combo-col"><strong>{col2_title}</strong>{col2}</div>
      </div>
    </div>
  </div>"""

def set_card(card_id, photo_key, name_ru, name_kz, persons, price, col1_title, col1, col2_title, col2):
    img = img_tag(P[photo_key], name_ru)
    return f"""
...
<head>
  ...
  <style>
    *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .combo-col strong{{color:var(--mid);font-size:11px;font-weight:800;display:block;margin-bottom:3px}}
...
<section class="section" id="combos">
  ...
  {combo_card("c-combo1","combo_klassika",
    ...
    "Вариант 1","Судак 750 г, Сазан 750 г, Картофельные дольки 350 г, Фри 250 г, Соус, лук, лимон",
    "Вариант 2","Кёксерке 750 г, Сазан 750 г, Картопсыналары 350 г, Фри 250 г, Тұздық, пияз, лимон")}
  {combo_card("c-combo2","combo_lyuks",
    "Комбо «Люкс»","«Люкс» Комбосы","12 990",
    "Вариант 1","Судак 750 г, Сом 750 г, Луковые кольца 10 шт, Картопсыналары 350 г, Соус, лук, лимон",
    "Вариант 2","Кёксерке 750 г, Сом 750 г, Пияз сақиналары 10 дана, Картопсыналары 350 г, Тұздық, пияз, лимон")}
  {combo_card("c-combo3","combo_shedevr",
    "Комбо «Шедевр»","«Шедевр» Комбосы","13 990",
    "Вариант 1","Сазан 750 г, Сом 750 г, Крылышки терияки 700 г, Луковые кольца 10 шт, Дольки 350 г, Соус, лук, лимон",
    "Вариант 2","Сазан 750 г, Сом 750 г, Терияки қанатшалары 700 г, Пияз сақиналары 10 дана, Картопсыналары 350 г, Тұздық, пияз, лимон")}
</section>
...
<section class="section" id="sets">
  ...
  {set_card("c-set1","set_mini",
    ...
    "Вариант 1","Сазан 500 г, Сом/Судак 500 г, Форель 400 г, Сёмга 300 г, Фри 250 г, Соус, лук, лимон",
    "Вариант 2","Сазан 500 г, Сом/Кёксерке 500 г, Ханбалық 400 г, Аксерке 300 г, Фри 250 г, Тұздық, пияз, лимон")}
  {set_card("c-set2","set_delikates",
    "Сет «Деликатес»","«Деликатес» сеті","На 5–6 персон","16 490",
    "Вариант 1","Сазан 500 г, Судак 500 г, Форель на гриле 800 г, Креветки 500 г, Фри 250 г, Овощи на гриле 250 г, Соус, лук, лимон",
    "Вариант 2","Сазан 500 г, Кёксерке 500 г, Грильдегі Ханбалық 800 г, Асшаяндар 500 г, Фри 250 г, Грильдегі көкөністер 350 г, Тұздық, пияз, лимон")}
  {set_card("c-set3","set_daryi",
    "Сет «Дары Океана»","«Теңіз сыйлары» сеті","На 5–6 персон","17 990",
    "Вариант 1","Сазан 500 г, Берш 550 г, Сёмга 700 г, Креветки 300 г, Фри 250 г, Дольки 350 г, Овощи 300 г, Соус, лук, лимон",
    "Вариант 2","Сазан 500 г, Берш 550 г, Аксерке 700 г, Асшаяндар 300 г, Фри 250 г, Картопсыналары 350 г, Грильдегі көкөністер 500 г, Тұздық, пияз, лимон")}
  {set_card("c-set4","set_simfoniya",
    "Сет «Морская симфония»","«Теңіз симфониясы» сеті","На 5–6 персон","23 490",
    "Вариант 1","Дорадо 400 г, Окунь 400 г, Судак 1 кг, Сёмга 700 г, Фри 250 г, Дольки 350 г, Королевские Креветки 350 г, Овощи на гриле 350 г, Соус, лук, лимон",
    "Вариант 2","Дорадо 400 г, Алабуға 400 г, Кёксерке 1 кг, Аксерке 700 г, Фри 250 г, Картопсыналары 350 г, Асшаяндар 350 г, Грильдегі Көкөністер 350 г, Тұздық, пияз, лимон")}
  {set_card("c-set5","set_freshfish",
    "Сет «Fresh Fish»","«Fresh Fish» сеті","На 6–7 персон","25 490",
    "Вариант 1","Сазан 500 г, Берш 500 г, Форель на гриле 800 г, Сёмга 700 г, Креветки 300 г, Фри 250 г, Овощи на гриле 300 г, Картопшарлары 250 г, Соус, лук, лимон",
    "Вариант 2","Сазан 500 г, Берш 500 г, Грильдегі Ханбалық 800 г, Аксерке 700 г, Асшаяндар 300 г, Фри 250 г, Грильдегі Көкөністер 300 г, Картоп Шарлары 250 г, Тұздық, пияз, лимон")}
</section>
...
print(f"\nDone! freshfish_menu.html = {size_kb} KB")
